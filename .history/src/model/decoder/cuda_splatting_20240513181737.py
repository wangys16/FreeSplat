...
def render_cuda(
    ...
    for i in range(b):
        ...
        # print('gaussian_means.type():', gaussian_means[i].type())
        # print('mean_gradients.type():', mean_gradients.type())
        # print('shs.type():', shs[i].type())
        # print('gaussian_opacities.type():', gaussian_opacities[i].type())
        # print('gaussian_covariances.type():', gaussian_covariances[i].type())
