...
class GRU2D_naive_Wweights(nn.Module):
    def __init__(self):
        ...
        hidden_channel = 64
        weights_dim = 24
        # self.mlp_z = nn.Linear(hidden_channel + input_channel + 2*weights_dim, hidden_channel)
        # self.mlp_r = nn.Linear(hidden_channel + input_channel + 2*weights_dim, hidden_channel)
        # self.mlp_n = nn.Linear(hidden_channel + input_channel + 1*weights_dim, hidden_channel)  # for extra input feats
