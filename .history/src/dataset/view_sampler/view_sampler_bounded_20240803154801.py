    ...
    def sample(
        ...
        for p in range(phase):
            ...
            for i in range(num_context_views-1):
                ...
                # target_views += index_target.tolist()
        ...
        #         index_start + self.cfg.min_distance_to_context_views,
        #         context_views[-1] + 1 - self.cfg.min_distance_to_context_views,
        #         size=(self.cfg.num_target_views,),
        #         device=device,
        #     )
        
        # print('contexts:', context_views_all)
        
        # sign = path[-1]
        # if self.cfg.extra and os.path.exists(path.replace(f'{sign}', f'{1-sign}')):
        
        # print(f'num_views: {num_views}, context_views_all: {context_views_all}, index_target: {index_target}')
