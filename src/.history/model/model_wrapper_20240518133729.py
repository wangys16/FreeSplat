    ...
    def on_test_end(self) -> None:
        ...
        print('psnr_inter_avg:', (np.array(self.benchmarker.benchmarks['psnr_inter']) 
            ...
            'lpips_inter_avg:', (np.array(self.benchmarker.benchmarks['lpips_inter']) 
                                * np.array(self.benchmarker.benchmarks['valid_inter'])).sum()
                                / np.array(self.benchmarker.benchmarks['valid_inter']).sum(),
            'depth_abs_diff_avg:', np.mean(self.benchmarker.benchmarks['depth_abs_diff']),
            'depth_rel_diff_avg:', np.mean(self.benchmarker.benchmarks['depth_rel_diff']),
            'depth_delta_25_avg:', np.mean(self.benchmarker.benchmarks['depth_delta_25']))
        try:
