...
class ModelWrapper(LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        for index, depth_render, depth_gt in zip(range(len(batch["context"][0]["index"][0])), output.depth[0], batch["target"]['depth'][0,:,0]):
    ...
    def on_test_end(self) -> None:
        ...
        print('psnr_inter_avg:', (np.array(self.benchmarker.benchmarks['psnr_inter']) 
            ...
            'depth_delta_25_avg:', np.array(self.benchmarker.benchmarks['depth_delta_25_avg']))
        try:
    ...
    def validation_step(self, batch, batch_idx):
        ...
        abs_diff, rel_diff, delta_25 = depth_render_loss(encoder_probabilistic_results, batch)
